...
/*generador del ejemplo para el problema de mezcla de k vectores ordenados. 
...
Se lanzan entonces k iteraciones de un algoritmo de muestreo aleatorio de tamaño
n para obtener los k vectores. Están ordeados porque el algoritmo de muestreo mantiene el orden */
